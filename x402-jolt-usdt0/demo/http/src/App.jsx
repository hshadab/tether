    ...
    return (
      <div style={S.welcomeCard}>
        ...
        <p style={S.welcomeSub}>
          Press <b>PLAY</b> to run 3 live scenarios: one legitimate payment and two attack attempts.
        </p>
  ...
  if (c.type === 'action') {
    return (
      <div style={S.actionCard}>
        ...
        {c.step === 'verify' && (
          <div style={S.console}>
            <div style={S.conHdr}><span style={S.conDotR}/><span style={S.conDotY}/><span style={S.conDotG}/><span style={S.conTitle}>server verification (2 checks)</span></div>
            <div style={S.conBody}>
              <div style={{...S.conLn,animationDelay:'0.4s'}}><span style={{color:'#f59e0b',fontWeight:700,flexShrink:0,fontSize:'0.56rem'}}>CHECK 1</span><span style={S.conD}> Binding — does this proof belong to this payment?</span></div>
              ...
              <div style={{...S.conLn,animationDelay:'1.9s'}}><span style={S.conArrOut}>{'\u2192'}</span><span style={S.conDRes}>If mismatch → 403 (payment tampered, reject before SNARK check)</span></div>
              <div style={{...S.conLn,animationDelay:'2.6s'}}><span style={{color:'#06b6d4',fontWeight:700,flexShrink:0,fontSize:'0.56rem'}}>CHECK 2</span><span style={S.conD}> SNARK — did the ML model actually run and approve?</span></div>
              ...
              <div style={{...S.conLn,animationDelay:'3.6s'}}><span style={S.conArrOut}>{'\u2192'}</span><span style={S.conDRes}>Cosigner verifies Jolt-Atlas SNARK proof (prevents forged proofs)</span></div>
            </div>
          </div>
        )}
      </div>
